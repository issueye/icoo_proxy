...
// Responses API request. Stream preserves the downstream request's intent.
// store is always false and reasoning.encrypted_content is always included so
// that the response translator has full context.
