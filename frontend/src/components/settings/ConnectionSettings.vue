<template>
  <section class="space-y-6">
    ...
    <div class="bg-secondary rounded-md border border-border p-6 space-y-4">
      ...
      <div>
        ...
        <input
          ...
          class="input-field w-full bg-secondary font-mono text-sm"
        />
    ...
    <div class="bg-secondary rounded-md border border-border p-6">
      ...
      <div class="space-y-3">
        <div class="flex items-center justify-between">
          <span class="text-muted-foreground text-sm">API 状态</span>
          <span
            :class="[
              'text-sm',
        ...
        <div class="flex items-center justify-between">
          <span class="text-muted-foreground text-sm">WebSocket</span>
          <span class="text-muted-foreground text-sm">{{ wsStatus }}</span>
        </div>
      </div>
    </div>
  </section>
