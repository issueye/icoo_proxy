<template>
  <div class="page-shell">
    <div class="page-frame">
      <section class="surface-panel page-panel flex flex-col w-full min-w-0">
        <ManagePage
          title="MCP 管理"
        ...
        >
          ...
          <template #overlay>
            ...
            >
              ...
              <div v-if="form.type === 'stdio'" class="dialog-section">
                <h4 class="dialog-section-title">stdio 配置</h4>
              ...
              <div v-else class="dialog-section">
                <h4 class="dialog-section-title">SSE 配置</h4>
              ...
              <div class="dialog-section">
                <h4 class="dialog-section-title">运行控制</h4>
            ...
            >
              ...
              <div v-if="selectedMCPTools.tools?.length" class="dialog-section">
                <h4 class="dialog-section-title">已发现工具</h4>
              ...
              <div v-else class="dialog-section text-center">
